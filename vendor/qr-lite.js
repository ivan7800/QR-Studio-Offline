/* QR Lite robusto: generador QR local basado en Kazuhiko Arase, envuelto para navegador. */
(function(global){
'use strict';
var modules={'./QRMode': function(require,module,exports){
module.exports = {
    MODE_NUMBER :       1 << 0,
    MODE_ALPHA_NUM :    1 << 1,
    MODE_8BIT_BYTE :    1 << 2,
...
var cache={};
function require(id){ if(!modules[id]) throw new Error('Módulo QR no encontrado: '+id); if(!cache[id]){ var module={exports:{}}; cache[id]=module; modules[id](require,module,module.exports); } return cache[id].exports; }
var QRCode=require('./index');
var ECL=require('./QRErrorCorrectLevel');
function build(text){
  var qr=new QRCode(-1,ECL.M);
